...
<a target="_blank" href="https://github.com/sirpdboy/luci-app-kucat-config/releases"> <img alt="GitHub release" src="https://img.shields.io/github/v/release/sirpdboy/luci-app-kucat-config"></a>
<a href="https://github.com/sirpdboy/luci-app-kucat-config/releases"><img alt="Downloads" src="https://img.shields.io/github/downloads/sirpdboy/luci-app-kucat-config/total?cacheSeconds=1"></a>
</p>
